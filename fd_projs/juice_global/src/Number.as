package 
{
	...
	public final class Number extends Object
	{
		...
		public native static function max (x:Number =-1.0/0, y:Number =-1.0/0, ...rest) : Number;
		
		public native static function min (x:Number = 1.0/0, y:Number = 1.0/0, ...rest) : Number;
