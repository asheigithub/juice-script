package
{
	...
	public final class Math
	{
		 ...
		 * @playerversion	Lite 4
		 */
		public native static function max (val1:Number =-1.0/0, val2:Number =-1.0/0, ...rest) : Number;
		 ...
		 * @playerversion	Lite 4
		 */
		public native static function min (val1:Number = 1.0/0, val2:Number = 1.0/0, ...rest) : Number;
		...
		public native static function pow (base:Number, pow:Number) : Number;
