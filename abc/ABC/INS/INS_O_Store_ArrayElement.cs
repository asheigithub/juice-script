...
{
	public sealed class INS_O_Store_ArrayElement : Instruction
	{
		public INS_O_Store_ArrayElement(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.O_Store_Array_Element;
