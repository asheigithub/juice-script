...
{
	public sealed class INS_O_Ld_Vector_Element : Instruction
	{
		public INS_O_Ld_Vector_Element(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.O_Ld_Vector_Element;
		...
		{
			return $"Ld_Vector_Element [{dst}] <- ({instance})[{name}]";
		}
