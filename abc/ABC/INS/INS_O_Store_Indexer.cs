...
{
	public sealed class INS_O_Store_Indexer : Instruction
	{
		public INS_O_Store_Indexer(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.O_Store_Indexer;
		...
		{
			return $"O_Store_Indexer [({instance})[{name}] <- {dst}";
		}
