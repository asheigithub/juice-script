...
{
	public sealed class INS_Mul_Mat22_Mat22 : Instruction
	{
		public INS_Mul_Mat22_Mat22(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.mul_Mat22_Mat22;
		...
		{
			return $"Mat22 * Mat22   [{dst}]<- (Matrix2x2)[{v1}] * (Matrix2x2)[{v2}]";
		}
