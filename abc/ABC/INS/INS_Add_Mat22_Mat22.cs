...
{
	public sealed class INS_Add_Mat22_Mat22 : Instruction
	{
		public override INS_Code INS_Code => INS_Code.add_Mat22_Mat22;

		public StackLocater v1;

		public StackLocater v2;

		public INS_Add_Mat22_Mat22(Token token) : base(token)
		{
		}
		...
		{
			return $"Add(+)   [{dst}]<- (Mat22)[{v1}]+(Mat22)[{v2}]";
		}
