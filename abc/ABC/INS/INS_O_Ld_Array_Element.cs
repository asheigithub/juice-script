...
{
	public sealed class INS_O_Ld_Array_Element : Instruction
	{
		public INS_O_Ld_Array_Element(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.O_Ld_Array_Element;
		...
		{
			return $"Ld_Array_Element [{dst}] <- ({instance})[{name}]";
		}
