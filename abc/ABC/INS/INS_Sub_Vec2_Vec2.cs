...
{
	public sealed class INS_Sub_Vec2_Vec2 : Instruction
	{
		public override INS_Code INS_Code => INS_Code.sub_Vec2_Vec2;

		public StackLocater v1;

		public StackLocater v2;

		public INS_Sub_Vec2_Vec2(Token token) : base(token)
		{
		}
		...
		{
			return $"Sub(-)   [{dst}]<- (Vector2)[{v1}]-(Vector2)[{v2}]";
		}
