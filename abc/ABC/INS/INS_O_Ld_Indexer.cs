...
{
	public sealed class INS_O_Ld_Indexer : Instruction
	{
		public INS_O_Ld_Indexer(Token token) : base(token)
		{
		}

		public override INS_Code INS_Code => INS_Code.O_Ld_Indexer;
		...
		{
			return $"Ld_Indexer [{dst}] <- ({instance})[{name}]";
		}
