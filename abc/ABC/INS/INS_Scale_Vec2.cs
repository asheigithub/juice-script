...
{
	public sealed class INS_Scale_Vec2 : Instruction
	{
		public override INS_Code INS_Code => INS_Code.scale_Vec2;

		public StackLocater vec;

		public StackLocater factor;

		public INS_Scale_Vec2(Token token) : base(token)
		{
		}
		...
		{
			return $"Scale_Vec2   [{dst}]<- (Vector2)[{vec}].Scale({factor})";
		}
