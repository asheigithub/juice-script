...
namespace compilerTests.CompileTest.function_apply
{
	[TestClass]
...
import ns1.BaseM;
BaseM.Test().apply(void 0);
assert.sameValue(this[""field""], undefined, 'The value of this[""field""] is expected to be undefined');


BaseM.Test().apply(this);
