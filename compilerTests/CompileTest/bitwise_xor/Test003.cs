...
//CHECK#1
if ((o ^ 1) !== 0) {
  throw new Test262Error('#1: ({valueOf: function() {return 1}} ^ 1) === 0. ');
}

o = {valueOf: function() {return 1}, toString: function() {return 0}};
//CHECK#2
if ((o ^ 1) !== 0) {
  throw new Test262Error('#2: ({valueOf: function() {return 1}, toString: function() {return 0}} ^ 1) === 0. ');
}

o = {valueOf: function() {return 1}, toString: function() {return {}}};
//CHECK#3
if ((o ^ 1) !== 0) {
  throw new Test262Error('#3: ({valueOf: function() {return 1}, toString: function() {return {}}} ^ 1) === 0. Actual: ' + ((o ^ 1)));
}
o = {valueOf: function() {return 1}, toString: function() {throw ""error""}};
//CHECK#4
try {
  if ((o ^ 1) !== 0) {
    throw new Test262Error('#4.1: ({valueOf: function() {return 1}, toString: function() {throw ""error""}} ^ 1) === 0. Actual: ' + ((o ^ 1)));
  }
}
catch (e) {
  if (e === ""error"") {
...
//CHECK#5
if ((1 ^ o) !== 0) {
  throw new Test262Error('#5: (1 ^ {toString: function() {return 1}}) === 0. Actual: ' + ((1 ^ o)));
}

o = {valueOf: function() {return {}}, toString: function() {return 1}};
//CHECK#6
if ((1 ^ o) !== 0) {
  throw new Test262Error('#6: (1 ^ {valueOf: function() {return {}}, toString: function() {return 1}}) === 0. Actual: ' + ((1 ^ o)));
}
