...
//CHECK#1
if ((a & b) !== 1) {
  throw new Test262Error('#1: (""1"" & ""1"") === 1. Actual: ' + ((a & b)));
}
...
//CHECK#2
if ((b & a) !== 1) {
  throw new Test262Error('#2: (new String(""1"") & ""1"") === 1. Actual: ' + ((b & a)));
}

//CHECK#3
if ((a & b) !== 1) {
  throw new Test262Error('#3: (""1"" & new String(""1"")) === 1. Actual: ' + ((a & b)));
}

//CHECK#4
if ((b & b) !== 1) {
  throw new Test262Error('#4: (new String(""1"") & new String(""1"")) === 1. Actual: ' + ((b & b)));
}
...
//CHECK#5
if ((a & b) !== 0) {
  throw new Test262Error('#5: (""x"" & ""1"") === 0. Actual: ' + ((a & b)));
}

//CHECK#6
if ((b & a) !== 0) {
  throw new Test262Error('#6: (""1"" & ""x"") === 0. Actual: ' + ((b & a)));
}
