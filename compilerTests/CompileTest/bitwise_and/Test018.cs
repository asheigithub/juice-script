...
//CHECK#1
if ((b & a) !== 1) {
  throw new Test262Error('#1: (true & ""1"") === 1. Actual: ' + ((b & a)));
}

//CHECK#2
if ((a & b) !== 1) {
  throw new Test262Error('#2: (""1"" & true) === 1. Actual: ' + ((a & b)));
}
...
//CHECK#3
if ((b & a) !== 1) {
  throw new Test262Error('#3: (new Boolean(true) & ""1"") === 1. Actual: ' + ((b & a)));
}

//CHECK#4
if ((a & b) !== 1) {
  throw new Test262Error('#4: (""1"" & new Boolean(true)) === 1. Actual: ' + ((a & b)));
}
