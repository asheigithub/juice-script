...
//CHECK#1
if ((a & b) !== 1) {
  throw new Test262Error('#1: (true & true) === 1. Actual: ' + ((a & b)));
}
...
//CHECK#2
if ((a & b) !== 1) {
  throw new Test262Error('#2: (new Boolean(true) & true) === 1. Actual: ' + ((a & b)));
}

//CHECK#3
if ((b & a) !== 1) {
  throw new Test262Error('#3: (true & new Boolean(true)) === 1. Actual: ' + ((b & a)));
}

//CHECK#4
if ((a & a) !== 1) {
  throw new Test262Error('#4: (new Boolean(true) & new Boolean(true)) === 1. Actual: ' + ((a & new a)));
}
