...
{
    [TestClass]
    public sealed class IndexOfStructTest : CodeTestBase
    {
...
function runTest():void {
    ...
    results.push((points.indexOf(p1) == 0) ? 1 : 0);
    results.push((points.indexOf(p2) == 1) ? 1 : 0);
    results.push((points.indexOf(p3) == 2) ? 1 : 0);
    
    var p4:Point = new Point();
    p4.x = 99; p4.y = 99;
    results.push((points.indexOf(p4) == -1) ? 1 : 0);
    
    results.push((points.indexOf(p2, 2) == -1) ? 1 : 0);
    results.push((points.indexOf(p2, 1) == 1) ? 1 : 0);
    
    var emptyPoints:Vector.<Point> = new <Point>[];
    results.push((emptyPoints.indexOf(p1) == -1) ? 1 : 0);
