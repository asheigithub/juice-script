...
{
    [TestClass]
    public class TestProperty26 : CodeTestBase
    {
...
package
{
	...
	public class Main extends BaseM
	{
		...
		private static function set B(i:*) 
		{		
			p = 999;
		}
	}
...
"
        ...
        protected override void TestIsPass(Player player, PlayerException ex)
        {
            player.ForceGC();
            {
                ...
                Assert.AreEqual(1234, a.ShortValue);

                NaNBoxing p = rtPayload.ReadSlot(1);
                Assert.AreEqual(NaNBoxing.BoxType.Undefined, p.ValueType);
                //Assert.AreEqual(999, p.ShortValue);
