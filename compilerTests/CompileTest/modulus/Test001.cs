...
namespace compilerTests.CompileTest.modulus
{
	[TestClass]
...
//CHECK#1
if (o % 2 !== 1) {
  throw new Test262Error('#1: {valueOf: function() {return 1}} % 2 === 1. Actual: ' + (o % 2));
}

o = {valueOf: function() {return 1}, toString: function() {return 0}} ;
//CHECK#2
if (o % 2 !== 1) {
  throw new Test262Error('#2: {valueOf: function() {return 1}, toString: function() {return 0}} % 2 === 1. Actual: ' + (o % 2));
}
o = {valueOf: function() {return 1}, toString: function() {return {}}} ;
//CHECK#3
if (o % 2 !== 1) {
  throw new Test262Error('#3: {valueOf: function() {return 1}, toString: function() {return {}}} % 2 === 1. Actual: ' + (o % 2));
}
o = {valueOf: function() {return 1}, toString: function() {throw ""error""}} ;
//CHECK#4
try {
  if (o % 2 !== 1) {
    throw new Test262Error('#4.1: {valueOf: function() {return 1}, toString: function() {throw ""error""}} % 2 === 1. Actual: ' + (o % 2));
  }
}
catch (e) {
  if (e === ""error"") {
...
o = {toString: function() {return 2}} ;
//CHECK#5
if (1 % o !== 1) {
  throw new Test262Error('#5: 1 % {toString: function() {return 2}} === 1. Actual: ' + (1 % o));
}

o = {valueOf: function() {return {}}, toString: function() {return 2}};
//CHECK#6
if (1 % o !== 1) {
  throw new Test262Error('#6: 1 % {valueOf: function() {return {}}, toString: function() {return 2}} === 1. Actual: ' + (1 % o));
}
o = {valueOf: function() {throw ""error""}, toString: function() {return 2}};
//CHECK#7
try {
  1 % o;
  throw new Test262Error('#7.1: 1 % {valueOf: function() {throw ""error""}, toString: function() {return 2}} throw ""error"". Actual: ' + (1 % o));
}  
catch (e) {
  if (e !== ""error"") {
