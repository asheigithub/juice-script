...
namespace compilerTests.CompileTest.object_hasownproperty
{
	[TestClass]
...
var c = O;
O[""fff""] = ""j"";
trace( c.hasOwnProperty(""fff"") );

trace( f.hasOwnProperty(""BBB"") );
...
trace( n.hasOwnProperty(""g"") );
trace( n.hasOwnProperty(""prefix"") );


var s = ""SS"";

trace( s.hasOwnProperty(""length"") );
