           ...
           player.ForceGC();
            {
				...
				Assert.AreEqual("66\r\n66\r\nProperty http://adobe.com/AS3/2006/builtin::LL not found on int and there is no default value.\r\n", print.GetOutput());


				NaNBoxing a = rtPayload.ReadSlot(0);
				Assert.AreEqual( NaNBoxing.BoxType.Int, a.ValueType );
				Assert.AreEqual(-65532, a.IntValue);
