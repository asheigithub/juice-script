           ...
           player.ForceGC();
            {
				...
				Assert.AreEqual("false\r\nBoolean\r\nBoolean\r\n[class Boolean]\r\nProperty http://adobe.com/AS3/2006/builtin::LL not found on Boolean and there is no default value.\r\n", print.GetOutput());


				NaNBoxing a = rtPayload.ReadSlot(0);
				Assert.AreEqual( NaNBoxing.BoxType.Boolean, a.ValueType );
				Assert.AreEqual( false, a.Boolean);
