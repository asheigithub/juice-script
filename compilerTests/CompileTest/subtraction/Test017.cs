...
//CHECK#1
if (t1 - null !== 1) {
  throw new Test262Error('#1: ""1"" - null === 1. Actual: ' + (t1 - null));
}

//CHECK#2
if (null - t1 !== -1) {
  throw new Test262Error('#2: null - ""1"" === -1. Actual: ' + (null - t1));
}
...
//CHECK#3
if (t1 - null !== 1) {
  throw new Test262Error('#3: new String(""1"") - null === 1. Actual: ' + (t1 - null));
}

//CHECK#4
if (null - t1 !== -1) {
  throw new Test262Error('#4: null - new String(""1"") === -1. Actual: ' + (null - t1));
}
