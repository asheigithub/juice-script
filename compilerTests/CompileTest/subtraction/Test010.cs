...
//CHECK#1
if (isNaN(t1 - t2) !== true) {
  throw new Test262Error('#1: {} - function(){return 1} === Not-a-Number. Actual: ' );
}
...
//CHECK#2
if (isNaN(t1- t2) !== true) {
  throw new Test262Error('#2: function(){return 1} - {} === Not-a-Number. Actual: ' );
}

//CHECK#3
if (isNaN(t1 -t1) !== true) {
  throw new Test262Error('#3: function(){return 1} - function(){return 1} === Not-a-Number. Actual: ' );
}
