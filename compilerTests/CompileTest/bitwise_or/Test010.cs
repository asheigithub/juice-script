...
//CHECK#1
if ((o | f) !== 0) {
  throw new Test262Error('#1: ({} | function(){return 1}) === 0. Actual: ' + ((o | f)));
}

//CHECK#2
if ((f | o) !== 0) {
  throw new Test262Error('#2: (function(){return 1} | {}) === 0. Actual: ' + (f | o));
}

//CHECK#3
if ((f | f) !== 0) {
  throw new Test262Error('#3: (function(){return 1} | function(){return 1}) === 0. Actual: ' + ((f | f)));
}

//CHECK#4
if ((o | o) !== 0) {
  throw new Test262Error('#4: ({} | {}) === 0. Actual: ' + ((o | o)));
}
