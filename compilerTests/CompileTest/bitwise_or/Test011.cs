...
//CHECK#1
if ((b | 1) !== 1) {
  throw new Test262Error('#1: (true | 1) === 1. Actual: ' + ((b | 1)));
}

//CHECK#2
if ((1 | b) !== 1) {
  throw new Test262Error('#2: (1 | true) === 1. Actual: ' + ((1 | b)));
}


//CHECK#5
if ((b | new Number(1)) !== 1) {
  throw new Test262Error('#5: (true | new Number(1)) === 1. Actual: ' + ((b | new Number(1))));
}

//CHECK#6
if ((new Number(1) | b) !== 1) {
  throw new Test262Error('#6: (new Number(1) | true) === 1. Actual: ' + ((new Number(1) | b)));
}
