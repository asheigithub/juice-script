...
{
	[TestClass]
	public sealed class Test065 : CodeTestBase
	{
...
assert.sameValue(count.catch1, 0, '1');
assert.sameValue(count.finally1, 1, '1');
...
assert.sameValue(count.catch1, 1, '3: catch count');
