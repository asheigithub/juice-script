...
{
	[TestClass]
	public sealed class Test064 : CodeTestBase
	{
...
assert.sameValue(count.catch1, 1, '1: catch count');
assert.sameValue(count.finally1, 1, '1: finally count');
...
assert.sameValue(count.catch1, 1, '2: catch count');
assert.sameValue(count.finally1, 1, '2: fiinally count');
...
assert.sameValue(count.catch1, 0, '3: catch count');
assert.sameValue(count.finally1, 1, '3: fiinally count');
