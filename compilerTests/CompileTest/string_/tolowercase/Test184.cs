...
{
	[TestClass]
	public sealed class substring_Test184 : CodeTestBase
	{
...
//////////////////////////////////////////////////////////////////////////////
//CHECK#1
if (o.toLowerCase() !== ""nan"") {
  throw new Test262Error('#1: Number.prototype.toLowerCase = String.prototype.toLowerCase; NaN.toLowerCase() === """"nan"""". Actual: ' + o.toLowerCase());
}
//
//////////////////////////////////////////////////////////////////////////////
