...
{
	[TestClass]
	public sealed class Test141 : CodeTestBase
	{
...
result = str.split(undefined, {valueOf: function() { return undefined; }});


assert.sameValue(result.length, 0, 'obj > undefined, result.length');

result = str.split(undefined, {valueOf: function() { return 0; }});
