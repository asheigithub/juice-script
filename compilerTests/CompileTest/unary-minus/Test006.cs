...
namespace compilerTests.CompileTest.unary_minus
{
	[TestClass]
...
//CHECK#1
if (-o !== -1) {
  throw new Test262Error('#1: -""1"" === -1. Actual: ' + (-o));
}

o = ""x"";
//CHECK#2
if (isNaN(-o) !== true) {
  throw new Test262Error('#2: -""x"" === Not-a-Number. Actual: ' + (-o));
}

o = ""-1"";
//CHECK#3
if (-o !== 1) {
  throw new Test262Error('#3: -new String(""-1"") === 1. Actual: ' + (-o));
}
