...
{
    [TestClass]
    public class TestMultiName_11 : CodeTestBase
    {
...
"
        ...
        public void Test()
        {
            ...
            catch (ResolverException ex)
            {
                ...
                Assert.IsTrue(ex.Message == "Attempted access of inaccessible property tns through a reference with static type u.");
