...
{
    [TestClass]
    public class TestMultiName9 : CodeTestBase
    {
...
"
        ...
        protected override void TestIsPass(Player player, PlayerException ex)
        {
            ...
            Assert.AreEqual(d.SByteValue, 3);
            ...
            Assert.AreEqual(f.ValueType, NaNBoxing.BoxType.Sbyte);
            Assert.AreEqual(f.SByteValue, 3);

            NaNBoxing g = payload.ReadSlot(6);
            Assert.AreEqual(g.ValueType, NaNBoxing.BoxType.Sbyte);
            Assert.AreEqual(g.SByteValue, 2);

            NaNBoxing h = payload.ReadSlot(7);
            Assert.AreEqual(h.ValueType, NaNBoxing.BoxType.Sbyte);
            Assert.AreEqual(h.SByteValue, 4);
