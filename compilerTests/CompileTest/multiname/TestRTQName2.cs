...
{
    [TestClass]
    public class TestRTQName2 : CodeTestBase
    {
...
"
        ...
        protected override void TestIsPass(Player player, PlayerException ex)
        {
            ...
            Assert.AreEqual(ex.ToDebugMessage(), "[Fault] exception,[Message]=TypeError: KKF is ambiguous; Found more than one matching binding.");
