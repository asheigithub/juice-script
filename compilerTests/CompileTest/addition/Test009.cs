...
if (1 + null !== 1) {
  throw new Error('#1: 1 + null === 1. Actual: ' + (1 + null));
}

//CHECK#2
if (null + 1 !== 1) {
  throw new Error('#2: null + 1 === 1. Actual: ' + (null + 1));
}

//CHECK#3
if (new Number(1) + null !== 1) {
  throw new Error('#3: new Number(1) + null === 1. Actual: ' + (new Number(1) + null));
}

//CHECK#4
if (null + new Number(1) !== 1) {
  throw new Error('#4: null + new Number(1) === 1. Actual: ' + (null + new Number(1)));
}
