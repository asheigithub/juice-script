...
//CHECK#1
if ((o + function(){return 1}) !== (o.toString() + function(){return 1}.toString())) {
  throw new Test262Error('#1: ({} + function(){return 1}) === ({}.toString() + function(){return 1}.toString()). Actual: ' + ((o + function(){return 1})));
}

//CHECK#2
if ((function(){return 1} + o) !== (function(){return 1}.toString() + o.toString())) {
  throw new Test262Error('#2: (function(){return 1} + {}) === (function(){return 1}.toString() + {}.toString()). Actual: ' + ((function(){return 1} + o)));
}
...
//CHECK#4
if ((o + o) !== (o.toString() + o.toString())) {
  throw new Test262Error('#4: ({} + {}) === ({}.toString() + {}.toString()). Actual: ' + ((o + o)));
}
