...
{
    [TestClass]
    public class TestCallFun16 : CodeTestBase
    {
...
"
        ...
        protected override void TestIsPass(Player player, PlayerException ex)
        {
            ...
            RtHeapInstance instance = player.Context.GC.Heap[o.HeapPtr];
            Assert.AreEqual(RtHeapTypeKind.GLOBAL, instance.TypeKind);
            Assert.AreEqual("Main", ((RtPayloadScriptClass)instance.facility).Meta.QName.Name);
