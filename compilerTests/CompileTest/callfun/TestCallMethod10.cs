...
{
    [TestClass]
    public class TestCallMethod10 : CodeTestBase
    {
...
package
{
	...
	public class Main extends BaseM
	{
		...
		internal override function CCC(aa)
		{
			super.CCC(aa);
		}
...
"
        ...
        public void Test()
        {
			...
			{
				Assert.AreEqual(ex.Message, "Method marked override must override another method.");
				raised = true;
			}
